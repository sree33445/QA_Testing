      ...
      <div className="w-full max-w-md p-8 rounded-xl shadow-xl bg-white/90 backdrop-blur-sm mx-4 md:mx-0 transform transition-all duration-300 hover:shadow-2xl relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-between items-center space-x-2">
            <p className="text-gray-600">Don't have an account? <a href="/logincomponents/signup" className="text-blue-600 hover:text-blue-800 hover:underline">Create an account</a></p>
          </div>
        </form>
      </div>
    </div>
