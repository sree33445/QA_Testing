...
const ResultPage = () => {
  ...
  useEffect(() => {
    ...
    setExamResults(results.sort((a, b) => b.timestamp.localeCompare(a.timestamp)));
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h1 className="text-2xl font-bold text-gray-800">No exam results found</h1>
  ...
  const percentage = (selectedExam.totalScore / selectedExam.maxPossibleScore) * 100;
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Select Exam Result</h2>
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {examResults.map((result) => {
              const resultPercentage = (result.totalScore / result.maxPossibleScore) * 100;
              ...
              return (
                ...
                >
                  ...
                  <div className="font-medium text-gray-800">
                    Score: {result.totalScore.toFixed(1)}/{result.maxPossibleScore.toFixed(1)}
                  </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">
            Exam Results - {new Date(selectedExam.timestamp).toLocaleDateString()}
          </h1>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              <p className="text-sm text-blue-600 font-medium mb-1">Total Score</p>
              <p className="text-3xl font-bold text-blue-800">
                {selectedExam.totalScore.toFixed(2)}/{selectedExam.maxPossibleScore.toFixed(2)}
              </p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg text-center">
              <p className="text-sm text-green-600 font-medium mb-1">Percentage</p>
              <p className="text-3xl font-bold text-green-800">{percentage.toFixed(1)}%</p>
            </div>
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm font-medium text-blue-600">
                        Score: {questionScore.toFixed(2)}/{maxQuestionScore.toFixed(2)}
                      </p>
                    </div>
                  </div>
                      ...
                      return (
                        <div 
                          ...
                          className={`p-3 rounded-lg ${
                            ...
                            !isSelected && isCorrect ? 'bg-yellow-50 border border-yellow-200' :
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div 
                        className={`h-2 rounded-full ${
                          questionPercentage >= 70 ? 'bg-green-500' :
                          questionPercentage >= 40 ? 'bg-yellow-500' :
                          'bg-red-500'
                        }`}
