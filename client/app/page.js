export default function Home() {
 ...
 <div className="mainbg absolute inset-0 z-0 
   bg-cover bg-center 
   filter brightness-50 blur-sm"></div>
 <div className="relative z-10 h-full w-full">
  ...
  <header className="h-20 bg-blue-900 bg-opacity-70 flex items-center justify-between px-4 md:px-10 shadow-lg">
   <div className="flex items-center space-x-4">
    ...
    <h1 className="text-white font-bold text-2xl md:text-3xl">QA TESTING</h1>
   </div>
   <nav className="flex space-x-4">
    <a href="/logincomponents/login" className="text-white hover:text-blue-200 transition-colors">
    ...
    <div className="space-y-6">
     <div className="bg-blue-00 bg-opacity-70 p-6 rounded-lg shadow-xl">
      ...
      <p className="text-xl font-semibold text-white opacity-80 leading-relaxed">
       A comprehensive platform designed to streamline assessment processes, 
       providing powerful tools for educators, students, and recruiters.
      </p>
     </div>
     ...
     <div className="grid md:grid-cols-2 gap-4">
      <div className="bg-white bg-opacity-20 p-6 rounded-lg backdrop-blur-sm border border-white border-opacity-30">
       ...
       <h3 className="font-semibold text-white mb-2 text-xl">Flexible Creation</h3>
      ...
      <div className="bg-white bg-opacity-20 p-6 rounded-lg backdrop-blur-sm border border-white border-opacity-30">
       ...
       <h3 className="font-semibold text-white mb-2 text-xl">Real-time Monitoring</h3>
       <p className="text-white opacity-70">
     ...
     <div className="bg-blue-00 bg-opacity-70 p-6 rounded-lg">
      <h3 className="text-white text-2xl font-bold mb-4">Key Features:</h3>
